...
public class SyntaxCodeGenerator extends CodeGenerator{
    ...
    public void generate(String fileName,Class<?> clazz,List<ISymbol> parse_str) throws Exception {
        ...
        instance.getClass().getMethod("generate", List.class).invoke(instance, parse_str);
    }
}
