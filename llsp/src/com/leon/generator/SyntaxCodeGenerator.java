...
public class SyntaxCodeGenerator extends CodeGenerator {
    ...
    public Object generate(File file,List<ISymbol> parse_str,String className) throws Exception {
        List<ISymbol> t = Utils.getSymbolList(new File("resourses/syntax.g"));
        ...
        LR1 lr1 = new LR1(s.g);
        List<ISymbol> list = Utils.getSymbolList(file);
        ...
        sb.append("\n");
        sb.append("\n\tpublic Object generate(List<ISymbol> list,String className,File file) throws Exception {");
        sb.append("\n\t\tList<ISymbol> t = Utils.getSymbolList(file);");
        ...
        return instance.getClass().getMethod("generate", List.class,String.class,File.class).invoke(instance, parse_str,className,file);
    }
