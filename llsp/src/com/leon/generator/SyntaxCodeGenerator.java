...
public class SyntaxCodeGenerator extends CodeGenerator {
    ...
    public Object generate(File file,List<ISymbol> parse_str) throws Exception {
        ...
        sb.append("\n");
        sb.append("\n\tpublic Object generate(List<ISymbol> list,File file) throws Exception {");
        ...
        sb.append("\n\t\tsb.append(\"\\n    }\");");
        sb.append("\n\t\tsb.append(\"\\n\"+s.footer);");
        sb.append("\n\t\treturn dynamic_compile(list, s.classname, sb.toString());");
        sb.append("\n\t}");
        sb.append("\n");
        sb.append("\n}");
        ...
        return instance.getClass().getMethod("generate", List.class,File.class).invoke(instance, parse_str,file);
    }
