...
public class SyntaxCodeGenerator extends CodeGenerator{
    ...
    public void generate(String fileName,Class<?> clazz) throws IOException {
        ...
        System.out.println("import com.leon.lr.LR1;");
        ...
        System.out.println("\tpublic IR() throws IOException {");
        System.out.println("\t}");
        System.out.println("\tpublic void generate(List<ISymbol> list) throws IOException {");
        System.out.println("\t\tList<ISymbol> t = Utils.getSymbolList(\""+fileName+"\", "+clazz.getName()+".class);");
        System.out.println("\t\tSyntax s = " + lr1.semantic.top() + ";");
        System.out.println("\t\tSystem.out.println(s.header);");
        System.out.println("\t\tLR1 lr1 = new LR1(s.g);");
        System.out.println("\t\tlr1.lr1_driver(list);");
        System.out.println("\t\tSystem.out.println(\"    public void generate(List<ISymbol> t){\");");
        System.out.println("\t\tSystem.out.println(\"        \"+lr1.semantic.top()+\";\");");
        System.out.println("\t\tSystem.out.println(\"    }\");");
        System.out.println("\t\tSystem.out.println(s.footer);");
        System.out.println("\t}");
        System.out.println("}");
    }
}
